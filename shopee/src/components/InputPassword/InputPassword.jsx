...
export default function InputPassword({...props}) {
  ...
  return (
    <S.FormControl focus={focus}>
      <input type={visiblePassword ? 'password' : 'text'} {...props}onFocus={()=>setFocus(true)} onBlur={()=> setFocus(false)}/>
      <button type='button' onClick={toggleVisiblePassword} tabIndex="-1">
        {visiblePassword && <svg fill="none" viewBox="0 0 20 10" className="_2nnXgl">
